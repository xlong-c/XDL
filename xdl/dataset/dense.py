"""Dense prediction datasets and transforms."""
...
class RecordSegmentationDataset(Dataset[Record]):
...
class RecordDetectionDataset(Dataset[Record]):
...
ManifestSegmentationDataset = RecordSegmentationDataset
ManifestDetectionDataset = RecordDetectionDataset
