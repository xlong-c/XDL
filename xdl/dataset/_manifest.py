...
def require_record_keys(
    ...
    *,
    ...
    """Validate that a manifest record contains the required keys."""
...
def resolve_record_path(record: Mapping[str, Any], key: str, base_dir: Path) -> Path:
    """Resolve a required path-like field from a manifest record."""
...
def build_sample_id(
    ...
    *,
    ...
    """Build a stable sample identifier from common manifest fields."""
